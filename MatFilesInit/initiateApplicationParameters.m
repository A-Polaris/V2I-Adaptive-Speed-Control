...
[simParams,varargin] = addNewParam(simParams,'cbrActive',false,'If CBR calculation enabled','bool',fileCfg,varargin{1});
...
% [dcc_active]
% Duration of the interval for the CBR calculation [s]
[simParams,varargin] = addNewParam(simParams,'dcc_active',false,'If DCC is enabled','bool',fileCfg,varargin{1});
