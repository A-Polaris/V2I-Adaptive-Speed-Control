...
[outParams,varargin]= addNewParam([],'outputFolder','Output1','Folder for the output files','string',fileCfg,varargin{1});
...
% Boolean to activate the print to file of the details for distances from 0
% up to the maximum awareness range
[outParams,varargin]= addNewParam(outParams,'printPacketReceptionRatio',true,'Activate the print to file of detailed PRR up to the maximum awareness range','bool',fileCfg,varargin{1});

if outParams.printPacketReceptionRatio
    % [prrResolution]
    [outParams,varargin]= addNewParam(outParams,'prrResolution',1,'Step of the distance for the calculation of the pdr [m]','integer',fileCfg,varargin{1});
