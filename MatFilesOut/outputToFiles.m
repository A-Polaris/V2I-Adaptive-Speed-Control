...
if fseek(fileMainID, 1, 'bof') == -1
    ...
    % 10 Outputs - Adaptive Speed
    fprintf(fileMainID,'Ada Speed\t');
    fprintf(fileMainID,'Dif Speed\t');
    fprintf(fileMainID,'AllDif\t');
    fprintf(fileMainID,'DifSP_Min\t');
    fprintf(fileMainID,'DifSP_Max\t');

    fprintf(fileMainID,'SafeDis\t');
    fprintf(fileMainID,'AllColl\t');
    fprintf(fileMainID,'CollRatio\n');
end
...
fprintf(fileMainID,'\t');
 ...
 if simParams.adaSpeed
  ...
  if simParams.Speed_Different
    ...
    fprintf(fileMainID,'%2f\t',simParams.DifSpeed_Min);
    fprintf(fileMainID,'%2f\t',simParams.DifSpeed_Max);
 else
    fprintf(fileMainID,'False\t');  
    fprintf(fileMainID,'--\t');
    fprintf(fileMainID,'--\t');
 ...
 if simParams.NumColli
    fprintf(fileMainID,'%2f\t',simParams.SafeDis);
    fprintf(fileMainID,'%2f\t',stationManagement.NumColli);
    fprintf(fileMainID,'%4f\t',stationManagement.NumColli./stationManagement.NumAllConnect);
 else
    fprintf(fileMainID,'--\t');
    fprintf(fileMainID,'--\t');
    fprintf(fileMainID,'--\t');
