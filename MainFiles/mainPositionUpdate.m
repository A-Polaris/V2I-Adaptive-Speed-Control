...
if simParams.typeOfScenario~=2 % Not traffic trace
    ...
    if simParams.adaSpeed
        [indexNewVehicles,indexOldVehicles,indexOldVehiclesToOld,positionManagement,stationManagement] = ...
           Collision_updatePosition(timeManagement,simValues,simParams,positionManagement,appParams,outParams,stationManagement);
    else
...
%%   Collision
if simParams.NumColli  %%%  Vehicle ID
    [stationManagement,positionManagement] = computeCollisions (timeManagement,stationManagement,simParams,positionManagement,simValues,appParams,outParams);
end
